...
TASKS_OGE: list[Task] = [
    ...
    Task(
        ...
        "5 и 6",
        options=["2 и 3", "5 и 6", "12 и 14", "26 и 28"],
        image="images/oge_irrational_compare.png",
    ),
    Task(
        "Степени и корни",
        "Найдите значение выражения:",
    ...
    Task(
        ...
        "-3",
        image="images/oge_quadratic_incomplete.png",
    ),
    Task(
        "Теория вероятностей",
    ...
    Task(
        ...
        "[2; 2,6]",
        options=["[2; 2,6]", "(−∞; 2,6]", "(−∞; 2] ∪ [2,6; +∞)", "[2; +∞)"],
        image="images/oge_system_inequalities.png",
    ),
    Task(
...
TASKS_EGE: list[Task] = [
    ...
    Task(
        "Стереометрия",
        "В прямоугольном параллелепипеде ABCDA₁B₁C₁D₁ известно, что AB = 5, BC = 4, AA₁ = 3. "
        "Найдите объём многогранника, вершинами которого являются точки A, B, C, D, A₁, B₁.",
        "30",
        image="images/ege_03_parallelepiped.png",
    ),
    Task(
        "Вероятность",
    ...
    Task(
        ...
        "1.4",
        image="images/ege_06_fractional_equation.png",
    ),
    Task(
        "Тригонометрия",
        "Найдите значение выражения:",
    ...
    Task(
        "Текстовая задача (совместная работа)",
        "Один мастер может выполнить заказ за 40 часов, а другой — за 24 часа. За сколько часов выполнят "
        "этот заказ оба мастера, работая вместе?",
        "15",
    ),
    Task(
        "Линейная функция и графики",
        "На рисунке изображён график функции вида f(x) = kx + b. Найдите значение f(7).",
        "13",
        image="images/ege_10_linear_graph.png",
    ),
]
...
TASKS_EGE_BASE: list[Task] = [
    ...
    Task(
        ...
        "Найдите значение выражения:",
        "32",
        image="images/egebase_new_powers.png",
    ),
    Task(
    ...
    Task(
        ...
        "Найдите значение выражения:",
        "-0.5",
        image="images/egebase_new_decimals.png",
    ),
    Task(
        "Тригонометрия",
        "Найдите значение выражения:",
